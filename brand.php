    ...
    <section id="contact" class="container my-5 py-5">
        <div class="container text-center mt-5">
            ...
            <p class="w-50 mx-auto">
                Каждая история начинается там, где заканчивается другая.
            </p>
            <p class="w-50 mx-auto">
                 Одежда invvi всегда будет сделана из органического хлопка. Всегда.
        </p>
        <p class="w-50 mx-auto">
            Эластана и полиэстера больше не существует. Только invvi.
    </p>
